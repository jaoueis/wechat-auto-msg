...
groupNames = ['group chat 1', 'group chat 2', 'group chat 3', 'group chat n'] # change the array items to target group chat names
...
nickNames = ['user 1', 'user 2', 'user 3', 'user n'] # change the array items to target user names
